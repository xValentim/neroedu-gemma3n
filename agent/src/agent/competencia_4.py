...
async def call_model_competencia_4(state: State, config: RunnableConfig) -> Dict[str, Any]:
...
graph = (
    ...
    .add_edge("__start__", "call_model_competencia_4")
    .compile(name="ENEM Competência 4 Graph")
)
