...
async def call_model_competencia_2(state: State, config: RunnableConfig) -> Dict[str, Any]:
...
graph = (
    ...
    .add_edge("__start__", "call_model_competencia_2")
    .compile(name="ENEM Competência 2 Graph")
)
